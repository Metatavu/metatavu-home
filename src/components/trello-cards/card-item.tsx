...
import type { TrelloCard, TrelloMember } from "src/generated/homeLambdasClient";
 ...
 */
const CardItem = ({ members, card, onOpenCard, onDeleteCard }: CardItemProps) => {
    ...
    >
      ...
      >
        ...
        >
              ...
              (card.comments || []).length > 0 ? (
                <Box>
                  {card.comments
                    ...
                    .map((text: any, memberId: any) => <div key={memberId}>{text}</div>) || (
          ...
          >
            <IconButton>
              <Badge badgeContent={card.comments?.length || 0} color="primary" overlap="circular">
